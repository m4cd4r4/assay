        ...
        <section className="border-b border-border px-6 pb-20 pt-24 md:pb-28 md:pt-32">
          <div className="mx-auto max-w-6xl">
            <div className="max-w-3xl">
              ...
              <h1 className="mb-8 font-serif text-3xl font-semibold leading-tight tracking-tight sm:text-4xl md:text-6xl md:leading-[1.1]">
                Five analysis passes.{" "}
                <span className="text-primary">Built to evaluate Claude on legacy code.</span>
              </h1>
              <p className="mb-10 max-w-xl text-lg leading-relaxed text-muted">
                Production-ready Next.js application that turns COBOL source into
                business rules, dependency maps, dead code reports, and data flow
                diagrams. Open source. Available on request.
              </p>
              <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded bg-primary px-6 py-3 text-center text-sm font-medium text-white transition-colors hover:bg-primary-hover"
                >
                  View source on GitHub
                </a>
                <a
                  href="/demo"
                  className="rounded border border-border px-6 py-3 text-center text-sm font-medium text-foreground transition-colors hover:bg-surface"
                >
                  Try live demo
                </a>
              </div>
            ...
            <div className="mt-16 grid grid-cols-2 gap-0 border-t border-border md:grid-cols-4">
              {[
                ...
                <div key={stat.label} className="border-r border-border py-6 pr-8 [&:nth-child(2n)]:border-r-0 md:[&:nth-child(2n)]:border-r md:last:border-r-0">
        ...
        <section id="contact" className="px-6 py-20 md:py-28">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mb-10 max-w-lg text-muted">
              Portfolio project demonstrating full-stack delivery: Next.js,
              Anthropic SDK, Vercel, accessibility, security. Source is open.
              Available as a paid engagement on request.
            </p>
